...
SECRET_KEY = 'django-insecure-a0sl#h^seups-%(ji69oo5m_dt-(bc0+n*9x+hd_9vm%6umm)k'
...
INSTALLED_APPS = [
    ...
    'expenses', # expenses app'ini ekledik
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Geçici olarak izinleri kaldır
    ],
